!function() {
    ...
    , function(t, n, e) {
        ...
        var s, c, i, o = e(5), n = e(3), r = e.n(n), a = window.jQuery, l = window.TweenMax, u = /Android|iPhone|iPad|iPod|BlackBerry|Windows Phone/g.test(navigator.userAgent || navigator.functions|| window.opera), d = a(window), f = a(document), p = a("body"), h = a("html");
        function v() {
            s = d.width(),
            c = d.height(),
            i = f.height()
